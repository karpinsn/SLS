...
/// \endcode
/// \sa \c J_Event_CreateCondition(), \c J_Event_SignalCondition(), \c J_Event_ExitCondition(), \c J_Event_ResetCondition(), \c J_STATUS_CODES
EXTERN_C GCFC_IMPORT_EXPORT J_STATUS_TYPE  J_Event_WaitForMultipleConditions(uint32_t nCount, const HANDLE* conditionHandles, DWORD timeout, J_COND_WAIT_RESULT* pWaitResult);
...
/// \sa \c J_Camera_Open(), \c J_STATUS_CODES
EXTERN_C GCFC_IMPORT_EXPORT J_STATUS_TYPE J_Node_GetRepresentation(NODE_HANDLE hNode, J_NODE_REPRESENTATION *pValue);
...
/// The node type has to be \c IInteger or \c IFloat 
/// \sa \c J_Camera_Open(), \c J_STATUS_CODES
EXTERN_C GCFC_IMPORT_EXPORT J_STATUS_TYPE J_Node_GetUnit(NODE_HANDLE hNode, int8_t* pBuffer, uint32_t* pSize);
...
/// \sa \c J_Camera_Open(), \c J_STATUS_CODES
EXTERN_C GCFC_IMPORT_EXPORT J_STATUS_TYPE J_Node_GetDocuURL(NODE_HANDLE hNode, int8_t* pBuffer, uint32_t* pSize);
...
/// \sa \c J_Camera_Open(), \c J_STATUS_CODES
EXTERN_C GCFC_IMPORT_EXPORT J_STATUS_TYPE J_Node_GetIsDeprecated(NODE_HANDLE hNode, uint32_t* pVal);
...
/// \sa \c J_Camera_Open(), \c J_STATUS_CODES
EXTERN_C GCFC_IMPORT_EXPORT J_STATUS_TYPE J_Node_GetFloatAlias(NODE_HANDLE hNode, NODE_HANDLE* phNode);
...
/// The node type has to be \c IFloat 
/// \sa \c J_Camera_Open(), \c J_STATUS_CODES
EXTERN_C GCFC_IMPORT_EXPORT J_STATUS_TYPE J_Node_GetDisplayNotation(NODE_HANDLE hNode, J_NODE_DISPLAY_NOTATION *pValue);
...
/// The node type has to be \c IFloat 
/// \sa \c J_Camera_Open(), \c J_STATUS_CODES
EXTERN_C GCFC_IMPORT_EXPORT J_STATUS_TYPE J_Node_GetDisplayPrecision(NODE_HANDLE hNode, int64_t *pValue);
...
/// The node type has to be \c IFloat 
/// \sa \c J_Camera_Open(), \c J_STATUS_CODES
EXTERN_C GCFC_IMPORT_EXPORT J_STATUS_TYPE J_Node_GetFloatHasInc(NODE_HANDLE hNode, uint32_t*pValue);
...
/// \sa \c J_Camera_Open(), \c J_STATUS_CODES
EXTERN_C GCFC_IMPORT_EXPORT J_STATUS_TYPE J_Node_GetFloatInc(NODE_HANDLE hNode, double* pValue);
...
/// \sa \c J_Camera_Open(), \c J_STATUS_CODES
EXTERN_C GCFC_IMPORT_EXPORT J_STATUS_TYPE J_Node_GetIntAlias(NODE_HANDLE hNode, NODE_HANDLE* phNode);
...
/// \sa \c J_Camera_Open(), \c J_STATUS_CODES
EXTERN_C GCFC_IMPORT_EXPORT J_STATUS_TYPE J_Node_GetEnumAlias(NODE_HANDLE hNode, NODE_HANDLE* phNode);
...
EXTERN_C GCFC_IMPORT_EXPORT J_STATUS_TYPE J_Image_OpenViewWindowA(LPCSTR pWindowName, POINT *pPoint, SIZE *pMaxSize, VIEW_HANDLE *pWin);
...
/// \endcode
/// \sa \c J_Image_OpenViewWindow(), \c J_Camera_GetNodeByName(), \c J_Node_ExecuteCommand(), \c J_STATUS_CODES
EXTERN_C GCFC_IMPORT_EXPORT J_STATUS_TYPE J_Image_OpenViewWindowW(LPCWSTR pWindowName, POINT *pPoint, SIZE *pMaxSize, VIEW_HANDLE *pWin);
...
/// \param  [out] *pWin        The handle of the created window (window object) is returned.
/// \retval                    Status code defined in the J_STATUS_CODES. If the function succeeds, returns J_ST_SUCCESS.
EXTERN_C GCFC_IMPORT_EXPORT J_STATUS_TYPE J_Image_OpenViewWindowExA(J_IVW_WINDOW_TYPE iWindowType, LPCSTR pWindowName, RECT *pFrameRect, SIZE *pMaxSize, HWND hParent, VIEW_HANDLE *pWin);
...
/// \param  [out] *pWin        The handle of the created window (window object) is returned.
/// \retval                    Status code defined in the J_STATUS_CODES. If the function succeeds, returns J_ST_SUCCESS.
EXTERN_C GCFC_IMPORT_EXPORT J_STATUS_TYPE J_Image_OpenViewWindowExW(J_IVW_WINDOW_TYPE iWindowType, LPCWSTR pWindowName, RECT *pFrameRect, SIZE *pMaxSize, HWND hParent, VIEW_HANDLE *pWin);
...
/// \retval                Status code defined in the J_STATUS_CODES. If the function succeeds, returns J_ST_SUCCESS.
EXTERN_C GCFC_IMPORT_EXPORT J_STATUS_TYPE J_Image_SetImageOffsetEx(VIEW_HANDLE hWin, POINT *pOffset, double ZoomRatioX, double ZoomRatioY);
...
///                           1.0  :1/100 of the original images is expanded to the window size. 
/// \retval                   Status code defined in the J_STATUS_CODES. If the function succeeds, returns J_ST_SUCCESS.
EXTERN_C GCFC_IMPORT_EXPORT J_STATUS_TYPE J_Image_GetImageOffsetEx(VIEW_HANDLE hWin, POINT *pOffset, double *pZoomRatioX, double *pZoomRatioY);
...
/// \retval                    Status code defined in the J_STATUS_CODES. If the function succeeds, returns J_ST_SUCCESS.
EXTERN_C GCFC_IMPORT_EXPORT J_STATUS_TYPE J_Image_SetViewWindowTitleA(VIEW_HANDLE hWin, LPCSTR pWindowTitle);
...
/// \retval                    Status code defined in the J_STATUS_CODES. If the function succeeds, returns J_ST_SUCCESS.
EXTERN_C GCFC_IMPORT_EXPORT J_STATUS_TYPE J_Image_SetViewWindowTitleW(VIEW_HANDLE hWin, LPCWSTR pWindowTitle);
...
/// \endcode
/// \sa \c J_Image_OpenViewWindow(), \c J_Camera_GetNodeByName(), \c J_Node_ExecuteCommand(), \c J_STATUS_CODES
EXTERN_C GCFC_IMPORT_EXPORT J_STATUS_TYPE J_Image_SetViewWindowOption(VIEW_HANDLE hWin, J_IVW_OPTION Option, void* pOptionValue);
...
/// \retval                    Status code defined in the \c J_STATUS_CODES. If the function succeeds, returns \c J_ST_SUCCESS.
EXTERN_C GCFC_IMPORT_EXPORT J_STATUS_TYPE J_Image_GetViewWindowOption(VIEW_HANDLE hWin, J_IVW_OPTION Option, void* pOptionValue);
...
/// \endcode
/// \sa \c J_Image_OpenViewWindow(), \c J_Camera_GetNodeByName(), \c J_Node_ExecuteCommand(), \c J_STATUS_CODES
EXTERN_C GCFC_IMPORT_EXPORT J_STATUS_TYPE J_Image_SetViewWindowCallback(VIEW_HANDLE hWin, J_IVW_CALLBACK_OBJECT CBObject, J_IVW_CALLBACK_FUNCTION CBFunction);
...
/// \retval                     Status code defined in the J_STATUS_CODES. If the function succeeds, returns J_ST_SUCCESS.
/// \sa \c J_Image_OpenStream(), \c J_Image_OpenStreamLight(), \c J_STREAM_INFO_CMD
EXTERN_C GCFC_IMPORT_EXPORT J_STATUS_TYPE J_Image_GetStreamHandle(THRD_HANDLE hThread, STREAM_HANDLE *phStream);
...
/// }
/// \endcode
EXTERN_C GCFC_IMPORT_EXPORT J_STATUS_TYPE J_Image_SaveFileA(J_tIMAGE_INFO * pBufferInfo, LPCSTR pPath);
...
/// }
/// \endcode
EXTERN_C GCFC_IMPORT_EXPORT J_STATUS_TYPE J_Image_SaveFileW(J_tIMAGE_INFO * pBufferInfo, LPCWSTR pPath);
...
/// }
/// \endcode
EXTERN_C GCFC_IMPORT_EXPORT J_STATUS_TYPE J_Image_SaveFileExA(J_tIMAGE_INFO * pBufferInfo, LPCSTR pPath, J_SIF_FILE_FORMAT iFileFormat=J_FF_TIFF,  uint8_t iEncoderParameter=75);
...
/// }
/// \endcode
EXTERN_C GCFC_IMPORT_EXPORT J_STATUS_TYPE J_Image_SaveFileExW(J_tIMAGE_INFO * pBufferInfo, LPCWSTR pPath, J_SIF_FILE_FORMAT iFileFormat=J_FF_TIFF,  uint8_t iEncoderParameter=75);
...
/// }
/// \endcode
EXTERN_C GCFC_IMPORT_EXPORT J_STATUS_TYPE J_Image_SaveFileRawA(J_tIMAGE_INFO * pBufferInfo, LPCSTR pPath);
...
/// }
/// \endcode
EXTERN_C GCFC_IMPORT_EXPORT J_STATUS_TYPE J_Image_SaveFileRawW(J_tIMAGE_INFO * pBufferInfo, LPCWSTR pPath);
...
/// }
/// \endcode
EXTERN_C GCFC_IMPORT_EXPORT J_STATUS_TYPE J_Image_LoadFileRawA(J_tIMAGE_INFO * pBufferInfo, LPCSTR pPath);
...
/// }
/// \endcode
EXTERN_C GCFC_IMPORT_EXPORT J_STATUS_TYPE J_Image_LoadFileRawW(J_tIMAGE_INFO * pBufferInfo, LPCWSTR pPath);
...
///                                SAVE_FORCE_ALL);
/// \endcode
EXTERN_C GCFC_IMPORT_EXPORT J_STATUS_TYPE J_Camera_SaveSettingsA(CAM_HANDLE hCam, LPCSTR sSettingsFileName, J_SAVE_SETTINGS_FLAG saveFlag = SAVE_AUTO);
...
///                                SAVE_FORCE_ALL);
/// \endcode
EXTERN_C GCFC_IMPORT_EXPORT J_STATUS_TYPE J_Camera_SaveSettingsW(CAM_HANDLE hCam, LPCWSTR sSettingsFileName, J_SAVE_SETTINGS_FLAG saveFlag = SAVE_AUTO);
...
/// }
/// \endcode
EXTERN_C GCFC_IMPORT_EXPORT J_STATUS_TYPE J_Camera_LoadSettingsA(CAM_HANDLE hCam, LPCSTR sSettingsFileName, J_LOAD_SETTINGS_FLAG loadFlag = LOAD_AUTO);
...
/// }
/// \endcode
EXTERN_C GCFC_IMPORT_EXPORT J_STATUS_TYPE J_Camera_LoadSettingsW(CAM_HANDLE hCam, LPCWSTR sSettingsFileName, J_LOAD_SETTINGS_FLAG loadFlag = LOAD_AUTO);
...
/// \retval                           Status code defined in the J_STATUS_CODES. If the function succeeds, returns J_ST_SUCCESS.
/// \sa \c J_Factory_Open()
EXTERN_C GCFC_IMPORT_EXPORT J_STATUS_TYPE J_Factory_SendActionCommand(FACTORY_HANDLE hFac, uint32_t iDeviceKey, uint32_t iGroupKey, uint32_t iGroupMask, J_tACTION_CMD_ACK* pAckBuffer, uint32_t* piNumOfAck);
/// @}
#endif
