...
#ifndef _MOCKHOLODECODER_H_
#define _MOCKHOLODECODER_H_
...
class MockHolodecoder : public AbstractGLContext
{
private:
...
public:
	MockHolodecoder(OpenGLWidget* glContext);
