...
#ifndef _WRENCH_GL_VAO_H_
#define _WRENCH_GL_VAO_H_
...
public:
  ...
  /**
    * Adds an IBO to this VAO. This should only be called once per VAO since
    * a VAO can only have one set of indicies
    *
    * @param ibo - Index buffer object (IBO) to add
    */
  void addIBO(IBO& ibo);
