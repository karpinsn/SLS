...
#ifndef _DEPTH_HOLOENCODER_H_
#define _DEPTH_HOLOENCODER_H_
...
class DepthHoloencoder : public IGLContext, public IEncoder
{
private:
...
public:
  ...
  /**
  * Creates a new DepthHoloencoder that can be used to encode any type of MeshInterchange
  */
  DepthHoloencoder(void);

  /**
  *	Initializes the DepthHoloencoder with default values (width and height = 512).
  */
  virtual void init();

  /**
  *	Initializes the DepthHoloencoder with the specified values.
  *
